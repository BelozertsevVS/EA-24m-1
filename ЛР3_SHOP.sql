CREATE DATABASE SHOP;							/*СТВОРЮЄМО БАЗУ ДАНИХ SHOP*/

USE SHOP										/* ОБИРАЄМО БАЗУ SHOP ДЛЯ РОБОТИ*/

CREATE TABLE SALES (							/*СТВОРЮЄМО ТАБЛИЦЮ Students*/
	SALES_ORDER_ID BIGINT,						/*ЗАДАЄМ ПЕРВІСНИЙ КЛЮЧ В КОЛОНЦІ STUDENTID ТА АТРИБУТИ (ЦЕЙ ТА 3 РЯДКИ НИЖЧЕ)*/
...
VALUES (43659, 11, '1753-01-01 00:00:00.000', '2011-06-12', '2011-06-07', 0, 29825,	279, 5,	184590.1346, 1971.5149	,616.0984	        ,'2011-06-07 00:00:00.000'),
	...
	SELECT* FROM SALES;										/*ВИБІРКА ДАНИХ З ТАБЛИЦІ*/
	
	DROP TABLE SALES;										/*ВИДАЛЯЄМО ТАБЛИЦЮ*/

	DROP DATABASE SHOP;										/*ВИДАЛЯЄМО БАЗУ ДАНИХ*/
